...
const MyPage = () => {
  const fullpageOptions = {
    ...
    scrollingSpeed: 1000,
    licenseKey: "YOUR_LICENSE_KEY", // Replace with your purchased license key
            ...
            <div className="section">
              <div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
                ...
                <div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
                  ...
                  >
                    <a href="mailto:Divyanshxtudio@gmail.com?subject=Hello&body=Hello Divyanshu,">
                      Divyanshxtudio@gmail.com
                    </a>
                  </motion.p>
                  {/* icons */}
                  <div className="flex justify-center items-center space-x-4">
                    <motion.a
                      href="mailto:Divyanshxtudio@gmail.com?subject=Hello&body=Hello Divyanshu,"
                    ...
                    <motion.a
                      href="https://github.com/divyanshsaini962"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                    ...
                    <motion.a
                      href="https://www.instagram.com/mdivyansh.saini/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                      initial={{ opacity: 0, y: 40 }}
                    ...
                    <motion.a
                      href="https://www.fiverr.com/divyanshusaini9/buying?source=avatar_menu_profile"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
                      initial={{ opacity: 0, y: 40 }}
