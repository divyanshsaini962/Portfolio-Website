				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						<p className="text-gray-600 text-justify title text-lg">
							Hey there, I&rsquo;m Divyanshu Saini, a
							...
							<span className="text-black font-medium">
								{" "}
								aspiring Web Developer from India
							</span>{" "}
							Currently, I’m on an exciting journey at a leading Indian university, 
							...
							<span className="text-black font-medium">
							My passion for technology and coding knows
							</span>{" "}
							no bounds, and I'm constantly exploring new advancements and trends in the field.
							 Beyond coding, I’m deeply interested in design, Web development, 
							 and the fascinating world of AI.
							<span className="text-black font-medium">
								{" "}
								In today’s fast-paced digital landscape, 
							</span>{" "}
							I believe that being a lifelong learner isn’t just a choice—it’s essential. 
