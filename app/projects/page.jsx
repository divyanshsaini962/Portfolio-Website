...
// images
import ReactChat1 from "@/public/projects/tech/Home.png";
import ReactChat2 from "@/public/projects/tech/Blog.png";
import ReactChat3 from "@/public/projects/tech/page.png";
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              Developed a high-performance, fully static blog website using
              React and Next.js, focused on speed, SEO, and user experience.
              Utilized Static Site Generation (SSG) for fast load times,
              integrated Markdown for easy content management, and implemented a
              responsive design. Enhanced accessibility with light/dark themes
              and optimized SEO with custom meta tags and structured data.
            </p>{" "}
            <div className="mt-3">
              <Button variation="primary">
                <Link href="projects/tech">More</Link>
              </Button>
              <Button variation="secondary">
                <a
                  href="https://www.techblogservice.online/"
                  target="_blank"
